                ...
                <tr key={r.id} className="border-t border-[var(--line)] align-top">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2 justify-end whitespace-nowrap">
                      ...
                      <a href={`/print/booking/${r.id}?type=quote`} target="_blank" className="text-xs text-[var(--gold)] hover:underline">報價單</a>
                      <a href={`/print/booking/${r.id}?type=invoice`} target="_blank" className="text-xs text-[var(--gold)] hover:underline">發票</a>
